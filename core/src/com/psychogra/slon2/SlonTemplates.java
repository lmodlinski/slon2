...
public class SlonTemplates
{
	...
	public Game getPopeGame()
	{
		...
		recipeList.add(this.getIngredient("kremowka_1", new Vector2(600, 900), ingredient, sound, 50.0f));
		recipeList.add(this.getIngredient("kremowka_2", new Vector2(1000, 900), ingredient, sound, 50.0f));
		recipeList.add(this.getIngredient("kremowka_3", new Vector2(1400, 900), ingredient, sound, 50.0f));

		ArrayList<Ingredient> tableList = new ArrayList<Ingredient>();
		tableList.add(this.getIngredient("kremowka_1", new Vector2(600, 200), ingredient, sound, 50.0f));
		tableList.add(this.getIngredient("kremowka_2", new Vector2(1000, 200), ingredient, sound, 50.0f));
		tableList.add(this.getIngredient("kremowka_3", new Vector2(1400, 200), ingredient, sound, 50.0f));
		tableList.add(this.getIngredient("piernik_1", new Vector2(1700, 200), piernik, sound, 50.0f));
		tableList.add(this.getIngredient("piernik_2", new Vector2(300, 200), piernik, sound, 50.0f));
